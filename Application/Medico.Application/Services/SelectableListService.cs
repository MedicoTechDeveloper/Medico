...
namespace Medico.Application.Services
{
        ...
        : BaseDeletableByIdService<SelectableList, SelectableListVm>, ISelectableListService
    {
        ...
        public async Task<IEnumerable<Docs>> GetDocList()
        {
            ...
            var chartData =
              await con.QueryAsync<Docs>(@"
                select JsonValues from SelectableList Where Title='DOC_NOTES_SUBJECT'",
              new
              { }, commandType: CommandType.Text);
            return chartData;
        }

        public async Task<IEnumerable<Docs>> GetNotesStatusList()
        {
            IDbConnection con = Connection;
            con.Open();
            var chartData =
              await con.QueryAsync<Docs>(@"
                select JsonValues from SelectableList Where Title='DOC_NOTES_STATUS'",
              new
              { }, commandType: CommandType.Text);
            return chartData;
        }
        ...
        public async Task<IEnumerable<Docs>> GetCategoryList()
        {
            ...
            var chartData =
              await con.QueryAsync<Docs>(@"
                select JsonValues from SelectableList Where Title='Lab_Test_Category'",
              new
              { }, commandType: CommandType.Text);
            return chartData;
        }
        ...
        public async Task<IEnumerable<Docs>> GetDiagnosisList()
        {
                ...
                var chartData =
             await con.QueryAsync<Docs>(@"
                select JsonValues from SelectableList Where Title='Diagnostic_Code'",
             new
             { }, commandType: CommandType.Text);
                return chartData;
